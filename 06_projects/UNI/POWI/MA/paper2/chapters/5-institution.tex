...
world in detail, but rely on \emph{selected concepts and their
	relationships} to operate effectively. Similarly, \textcite{lecun2022}
proposes that autonomous intelligence requires a configurable
world model that can generalize, simulate, and guide actions in
unfamiliar contexts, rather than simply react to inputs.
