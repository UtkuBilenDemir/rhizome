...
\begin{enumerate}
	\item we must open the black box and examine the technical architecture of these models;
	\item we need to analyse \gls{genai} models as they deploy agency as they are
	      in mediation with individuals regardless
	      of their ability to be autonome.
