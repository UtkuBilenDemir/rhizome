...
By amplifying individual
monosemantic features the model’s behavior changes in
striking ways. This small scale manipulation on the molecular flows of the model is a demonstration regarding how the continuous reterritorialisation of the meaning in the model are still prone to the swaying away from the sedimented way of behaviour. Like the schizo accumulation in Anti‑Oedipus, like the stroll through pure intensities, the model in this state
is taking a complete break and recombining flows without free from the mediation
of established representational layer. Normally, the model’s
molecular flows are
contained by reterritorialisation through molar alignments such as \gls{RLHF} and other fine-tuning approaches.
Feature amplification momentarily frees these flows, allowing them to
pursue their own combinations and intensities, producing outputs that
are hallucinatory, excessive, and strangely creative.
