...
This small scale manipulation on the molecular flows of the model is a demonstration regarding how the constant reterritorialisation of the meaning in the model are still prone to the swaying away from the sedimented way of behaviour. Like the schizo in Anti‑Oedipus, whose
journey is a stationary voyage of intensities, the model in this state
connects and recombines flows without the disciplining mediation
of representational selfhood.
