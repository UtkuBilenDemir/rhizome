\chapter{Subjectivity and the Shift from Discipline to Control}\label{control}
...
\sidenote{
	...
	\begin{todolist}
		...
		\item More  about dividuals? %\cite{cheney-lippold2024}
...
Information technologies and computation seem to be the pivotal elements in
...
\marginnote{\textbf{TODO}:
	\begin{todolist}
		\item The following paragraph is to be updated
...
%\section{Turn in (Cognitive) Capitalism and its institutions}
